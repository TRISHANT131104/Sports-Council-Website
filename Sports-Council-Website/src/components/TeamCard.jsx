...
export default function TeamCard({ id, Img, Name, phoneNumber, EmailID }) {
  return (
    <div key={id} className="mb-5 border p-4 shadow-lg flex flex-col justify-center items-center h-full w-auto border-black">
      ...
      <div className='flex flex-col w-full items-center justify-start h-full'>
        ...
        <p className="mt-5 text-lg">Phone No. :{phoneNumber}</p>
