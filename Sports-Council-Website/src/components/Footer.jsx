      ...
      <div className='flex justify-between p-5 mb-10'>
        <div className='flex flex-col justify-between gap-2'>
            ...
            <div className='flex gap-4 justify-start items-center'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 128 128"><path d="M75.916 54.2L122.542 0h-11.05L71.008 47.06L38.672 0H1.376l48.898 71.164L1.376 128h11.05L55.18 78.303L89.328 128h37.296L75.913 54.2ZM60.782 71.79l-4.955-7.086l-39.42-56.386h16.972L65.19 53.824l4.954 7.086l41.353 59.15h-16.97L60.782 71.793Z"/></svg>
            </div>
        </div>
        <div className='flex justify-center items-center'>
            <div className='text-2xl py-3 px-5 rounded-full bg-gray-400 hover:bg-black hover:text-white transition-all duration-300 cursor-pointer'>Contact Us</div>
        </div>
      </div>
