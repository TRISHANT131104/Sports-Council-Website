        ...
        <div className='p-5 w-full px-20'>
                {facilities && facilities.length > 0 ? (
                    facilities.map((facility) => (
                        <div key={facility.id} className="mb-5 border p-4 shadow-md hover:shadow-2xl flex-col lg:flex-row justify-center items-center h-full w-full border-black transition-all duration-300 md:flex">
                            <div>
                            <img src={`${facility.Img}`} alt={facility.Title} className="w-[600px] h-auto md:m-5 p-5 md:p-10" />
                            </div>
